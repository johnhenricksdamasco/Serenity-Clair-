...
<div class="container">
  <h1 style="margin-top: 5px; margin-left: 210px;" class="page-header text-center">Stress Reliever</h1>
  <div class="row">
          ...
          <tbody>
            <?php
              ...
              while($row = $query->fetch_assoc()){
                ...
                include('Sedit_delete_modal.php');
              }
              /////////////////
